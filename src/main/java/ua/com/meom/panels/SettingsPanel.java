...
public class SettingsPanel extends JPanel {
    ...
    private JLabel settingsLabel, settingsHintLabel, levelLabel, soundLabel;
    private JComboBox levelBox, soundBox;
    ...
    private void GUI() {
        ...
        settingsLabel = new JLabel(String.format(rb.getString("settings_label"), rb.getString("continue_button")));
        ...
        levelLabel.setBounds((Constants.Common.MAIN_WINDOW_WIDTH / 2) - (Constants.Common.BUTTON_WIDTH / 2), settingsHintLabel.getY() + settingsHintLabel.getHeight() + Constants.Common.ELEMENTS_CLEARANCE, Constants.Common.BUTTON_WIDTH / 2, Constants.Common.BUTTON_HEIGHT / 2);
        this.add(levelLabel);

        levelBox = new JComboBox(GameContext.getAvailableLevels());
