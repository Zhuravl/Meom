package ua.com.meom.frames;

import ua.com.meom.constants.Constants;
import ua.com.meom.enums.Language;
...
public class LandingFrame extends JFrame {
    ...
    private void GUI() {
        ...
        labelLogo.setBounds(Constants.Common.ELEMENTS_CLEARANCE * 6, Constants.Common.ELEMENTS_CLEARANCE * 2, 150, 150);
        try {
        ...
        labelName.setForeground(Constants.Common.LOGO_COLOR);
        labelName.setHorizontalAlignment(SwingConstants.LEFT);
        labelName.setVerticalAlignment(SwingConstants.TOP);
        labelName.setBounds(labelLogo.getX() + labelLogo.getWidth() + Constants.Common.ELEMENTS_CLEARANCE, labelLogo.getY(), 300, 100);
        contentPane.add(labelName);

        labelPromo = new JLabel(Constants.Common.APP_PROMO.toUpperCase());
        labelPromo.setFont(Constants.Common.FONT_HINT);
        labelPromo.setForeground(Constants.Common.LOGO_COLOR);
